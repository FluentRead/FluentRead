...
4. Paste a sentence into the match preview to check which terms apply.

Changes save automatically and apply to the next translation. Restore existing webpage translations before translating again.
