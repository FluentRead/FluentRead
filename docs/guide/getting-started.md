...
当原文已明确属于目标中文书写体系时，会跳过翻译；少量 AI、CoT、OpenAI 等缩写不会让整段中文重复翻译。简繁混排、含完整外语内容或无法确定书写体系时，仍会尝试翻译。

翻译服务先保留“免费翻译服务”，不用填写密钥。网络不通或免费服务繁忙时，可以稍后重试，或[选择其他服务](/config/translation-engines)。

<figure class="doc-figure">
  <a href="/screenshots/popup.webp" target="_blank" rel="noopener"><img class="doc-screenshot popup" src="/screenshots/popup.webp" width="720" height="1120" alt="扩展菜单里的语言、免费翻译服务与翻译页面按钮" /></a>
...
需要拆解长句或解释用法时，再配置[翻译卡片](/guide/deepseek-harness)。普通划词翻译与 AI 讲解是两种可以分别设置的工具。
