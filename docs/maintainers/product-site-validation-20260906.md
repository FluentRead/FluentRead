...
- 中英文 README、首页与全部用户指南；首页突出 GPL-3.0 开源及翻译卡片对 DeepSeek Harness 会话内核的浏览器适配。
...
| 截图像素 | 整页 2560×1600，菜单 720×1120；划词特写 1400×960，翻译卡片特写 840×1140 |
...
- 截图采集在配置完成后关闭本次其他扩展页面，检查翻译卡片没有“设置已更新”或“已停止”的过渡状态再导出。
